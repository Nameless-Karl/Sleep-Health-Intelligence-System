...
### 1. The "Efficiency" Paradox (BMI & Stress)
...
![Composition of the "Sleep Quality 9"  Group by Occupation](occupation_chart.png)
...
* `Tinyuka_2025_Project.ipynb`: The main analysis notebook.
* `Sleep_health_dataset.csv`: The raw data.
* `images/`: Contains visualization exports.
